...
/*
 * INCLUDE P2P HOSTING NETWORK RPC CONFIGURATION SETTINGS
 */
...
$className = $serviceComponents[count($serviceComponents) - 1];
...
catch( virtualHostFrameworkJsonRpcException $ex ) {

      $error->SetError( $ex->getCode(), $ex->message );
      $error->SendAndExit();
}
...
class virtualHostFrameworkException extends Exception {
      ...
      public function virtualHostFrameworkException( $message, $code ) {

             $this->code    = $code;
             $this->message = "virtualHostFrameworkException: " . $message;
             
             $error->HandleException( self );
      }
}
class virtualHostFrameworkJsonRpcException extends virtualHostFrameworkException {
      ...
      public function virtualHostFrameworkJsonRpcException( $message, $code ) {

             $this->code    = $code;
             $this->message = "virtualHostFrameworkJsonRpcException: " . $message;
