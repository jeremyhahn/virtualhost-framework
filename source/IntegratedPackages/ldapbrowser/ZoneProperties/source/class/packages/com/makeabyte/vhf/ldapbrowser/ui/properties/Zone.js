...
************************************************************************ */
qx.Class.define( "packages.com.makeabyte.vhf.ldapbrowser.ui.properties.Zone", {
  ...
  */
  ...
  members : {
    ...
    main : function() {
          ...
          // Set up the window
       this.setZonePropWin( new qx.ui.window.Window( "Zone Properties", "icon/16/" + this.getWireFrame().getAppIcon() ) );
       this.getZonePropWin().set({
		          showMinimize: true,
		          allowMinimize: false,
		          allowMaximize: true
       });
	   this.getZonePropWin().setSpace( 200, 400, 0, 450 );  // left // width // top // height
	   this.getWireFrame()._addToWorkspace( this.getZonePropWin() );
	   this.getZonePropWin().removeAll();
       ...
       var txtName = new qx.ui.form.TextField();
           txtName.set({
        	...
        	right: 30,
        	width: '60%',
        	value: this.getZoneObj().associateddomain[0]
       });
       ...
       var txtSerial = new qx.ui.form.Spinner( 0, 0, 1000000000000000 );
           txtSerial.set({
           	  ...
           	  right: 30,
           	  width: '60%',
           	  value: (this.getZoneObj().soarecord == undefined) ? "" : this.getZoneObj().soarecord[0].split( " " )[2]              	  
       });
       ...
       var txtNameserver = new qx.ui.form.TextField();
           txtNameserver.set({
        	...
        	right: 30,
        	width: '60%',
        	value: (this.getZoneObj().soarecord == undefined) ? "" : this.getZoneObj().soarecord[0].split( " " )[0]
       });
       ...
       var txtResponsible = new qx.ui.form.TextField();
           txtResponsible.set({
        	...
        	right: 30,
        	width: '60%',
        	value: (this.getZoneObj().soarecord == undefined) ? "" : this.getZoneObj().soarecord[0].split( " " )[1]
       });
       ...
       var txtRefresh = new qx.ui.form.Spinner( 0, 0, 1000000000000000 );
           txtRefresh.set({
        	...
        	right: 30,
        	width: '60%',
        	value: (this.getZoneObj().soarecord == undefined) ? "" : this.getZoneObj().soarecord[0].split( " " )[3]
       });
       ...
       var txtRetry = new qx.ui.form.Spinner( 0, 0, 1000000000000000 );
           txtRetry.set({
        	...
        	right: 30,
        	width: '60%',
        	value: (this.getZoneObj().soarecord == undefined) ? "" : this.getZoneObj().soarecord[0].split( " " )[4]
       });
       ...
       var txtExpire = new qx.ui.form.Spinner( 0, 0, 1000000000000000 );
           txtExpire.set({
        	...
        	right: 30,
        	width: '60%',
        	value: (this.getZoneObj().soarecord == undefined) ? "" : this.getZoneObj().soarecord[0].split( " " )[5]
       });
       ...
       var txtTTL = new qx.ui.form.Spinner( 0, 0, 1000000000000000 );
           txtTTL.set({
        	...
        	right: 30,
        	width: '60%',
        	value: (this.getZoneObj().soarecord == undefined) ? "" : this.getZoneObj().soarecord[0].split( " " )[6]
       });
       ...
       var btnOK = new qx.ui.form.Button( "OK", "icon/16/actions/dialog-ok.png" );
           ...
           btnOK.addEventListener( "execute", function( e ) { 
                  ...
                  this.getWireFrame()._setStatusText( "Updating zone..." );

                  // Format RPC request as JSON
                  var json = '[' +
                                   '{ "name" : "dn", "dn" : "' + this.getZoneObj().dn + '" },' +
                  ...
                  this.getWireFrame()._callAsyncRpc( callback, "core.rpc.API", "invoke", "DNS", "updateZone", json );

                  // Close the window
                  this.getZonePropWin().close();
          }, this );
    ...
    __updateAttributeHandler : function( result, ex, id ) {
    	...
    	if( result ) {
            ...
            var parentDn =  this.getZoneObj().dn.replace( "dc=" + this.getZoneObj().dc[0] + ",", "" );
