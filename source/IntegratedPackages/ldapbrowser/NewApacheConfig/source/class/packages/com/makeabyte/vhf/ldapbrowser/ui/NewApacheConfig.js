...
qx.Class.define( "packages.com.makeabyte.vhf.ldapbrowser.ui.NewApacheConfig", {
  ...
  construct : function( args ) {
      ...
      this.setParentDn( args[0] );
      this.setCallback( args[1] );

           this.setApacheConfigWin( new qx.ui.window.Window( " New Apache Virtual Host", "icon/16/" + this.getAppIcon() ) );
	       ...
	       this.getWireFrame()._addToWorkspace( this.getApacheConfigWin() );
 		   ...
 		   var at1 = new qx.ui.basic.Atom( "Enter the requested Apache virtual host configuration directives.", "resource/vhf/icon/apache.png" );
	       ...
	       var t1 = new qx.ui.pageview.tabview.Button( "General", "icon/16/devices/drive-optical.png" );
     	       t1.setChecked( true );
	       var t2 = new qx.ui.pageview.tabview.Button( "Members", "icon/16/devices/drive-optical.png" );
           ...
           // Create dn
           var dn = "apacheServerName=" + txtServerName.getValue() + "," + this.getParentDn();
           var json = '[' +
           	                 '{ "name" : "dn", "dn" : "' + dn + '" },' +
              ...
              var callback = new qx.lang.Function.bind( this.__installApacheConfigHandler, this );
              this.getWireFrame()._callAsyncRpc( callback, "core.rpc.API", "invoke", "HTTP", "add", json );
           ...
           // Add the rest of the elements and open the window
  ...
  */
  ...
  members : {
     ...
     __installApacheConfigHandler : function( result, ex, id ) {
        ...
        if( result ) {
            ...
            this.getCallback()( this.getParentDn() );
